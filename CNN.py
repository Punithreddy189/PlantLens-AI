...
class CNN(nn.Module):
    def __init__(self, K):
        ...
        self.dense_layers = nn.Sequential(
            ...
            # Changed from hardcoded 50176 to handle potential variations, 
            # though the input image size is fixed at 224x224.
            nn.ReLU(),
            nn.Dropout(0.4),
            nn.Linear(1024, K),
        )
...
def get_classes(classes_file='classes.txt'):
    ...
    if os.path.exists(classes_file):
        ...
        # Fallback to original classes if file doesn't exist
        return {
            ...
            35: 'Tomato___Target_Spot', 36: 'Tomato___Tomato_Yellow_Leaf_Curl_Virus', 37: 'Tomato___Tomato_mosaic_virus',
            38: 'Tomato___healthy'
        }
